...
function NCODailyForm(props) {
    ...
    const enteredjeCheck = jeCheckInputRef.current.value;
	...
	return (
		<Card>
			<form className={classes.form} onSubmit={submitHandler}>
				...
				<div className={classes.control}>
					<label htmlFor='jeCheck'>
						Have you checked in with your Junior Enlisted on their task
						completion
					</label>
					<input type='checkbox' ref={jeCheckInputRef} />
				</div>
				<div className={classes.control}>
